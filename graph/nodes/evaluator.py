...
llm = ChatOpenAI(model="nvidia/nemotron-3-ultra-550b-a55b:free", openai_api_key=OPENROUTER_API_KEY, openai_api_base="https://openrouter.ai/api/v1", max_retries=1, timeout=20) if OPENROUTER_API_KEY else None
